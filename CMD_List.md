...
| PK_MIC_END                         |                      |
| PK_BATTLE_PRE                      | pk_未知                |
| PK_BATTLE_PRE_NEW                  | pk_未知                |
| PK_BATTLE_START                    | pk_未知                |
| PK_BATTLE_START_NEW                | pk_未知                |
| PK_BATTLE_PROCESS                  | pk                   |
| PK_BATTLE_PROCESS_NEW              | pk_new               |
| PK_BATTLE_FINAL_PROCESS            | pk_冷却                |
| PK_BATTLE_PRO_TYPE                 |                      |
| PK_BATTLE_GIFT                     |                      |
...
| PK_BATTLE_VOTES_ADD                |                      |
| PK_BATTLE_END                      | pk_结束                |
| PK_BATTLE_SETTLE                   | pk_未知                |
| PK_BATTLE_SETTLE_USER              | pk_未知                |
| PK_BATTLE_SETTLE_V2                | pk_未知                |
| PK_BATTLE_SETTLE_NEW               |                      |
| PK_BATTLE_PUNISH_END               |                      |
| PK_BATTLE_VIDEO_PUNISH_BEGIN       |                      |
| PK_BATTLE_VIDEO_PUNISH_END         |                      |
| PK_BATTLE_RANK_CHANGE              | pk_未知                |
| PREPARING                          | 准备中(未开播或下播)          |
| ROOM_REFRESH                       |                      |
| ROOM_SKIN_MSG                      |                      |
| TV_START                           |                      |
| RAFFLE_START                       |                      |
...
| SUPER_CHAT_ENTRANCE                |                      |
| SUPER_CHAT_AUDIT                   |                      |
| ANCHOR_LOT_CHECKSTATUS             | 直播间抽奖_未知             |
| ANCHOR_LOT_START                   | 直播间抽奖开始              |
| ANCHOR_LOT_END                     | 直播间抽奖结束              |
| ANCHOR_LOT_AWARD                   | 直播间抽奖结果              |
| CHASE_FRAME_SWITCH                 |                      |
| WATCH_LPL_EXPIRED                  |                      |
...
| AREA_RANK_CHANGED                  | 切换分区排行榜 (下播会切换分区排行榜) |
| VTR_GIFT_LOTTERY                   |                      |
...
| ONLINE_RANK_COUNT                  | 未知                   | 
 ...
 | HOT_ROOM_NOTIFY                    | 未知                   |
| RECOMMEND_CARD                     | 推荐购买(图片)             |
| GOTO_BUY_FLOW                      | 正在购买(购物车)            |
